...
def HiloPrincipal():
    ...
    title="Descargador de vídeos de David"
    choices = ["Single Video","PlayList", "Exit"]
    ...
    if (reply != "Exit"):
        ...
        if (URLorTEXTBoolString == 'y'):
            ...
            #Si no es playlist
            if (reply == "Single Video"):
                SingleDownload(video_url)

            #Si es playlist
            elif (reply == "PlayList"):
                PlayListDownload(video_url)
